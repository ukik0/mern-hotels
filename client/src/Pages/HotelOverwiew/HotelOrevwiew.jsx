    ...
    return (<>
        ...
        <div className={cl.hotel__container}>
            ...
            <div className={cl.hotel__wrapper}>
                ...
                <h1 className={cl.hotel__title}></h1>
                ...
                <div className={cl.hotel__image}>
                    {photos.map((photo, idx) => (<div key={photo.src} className={cl.hotel__image__wrapper}>
                        <img onClick={() => handleOpen(idx)} src={photo.src} alt="img"/>
                    </div>))}
                </div>
